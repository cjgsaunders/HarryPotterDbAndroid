...
class CharacterDaoTest {
    ...
    fun upsertCharacter_insertsCharacter() = runTest {
        val character = CharacterEntity(id = "1", name = "Harry Potter", actor = "Daniel Radcliffe", dateOfBirth = "","", true, "", "")
    ...
    fun getAllData_returnsAllCharacters() = runTest {
        val character1 = CharacterEntity(id = "1", name = "Harry Potter", actor = "Daniel Radcliffe", dateOfBirth = "","", true, "", "")
        val character2 = CharacterEntity(id = "2", name = "Hermione Granger", actor = "Emma Watson", dateOfBirth = "","", true, "", "")
    ...
    @Test
    fun searchCharactersWithEmptyString_findsNothing() = runTest {
        val character = CharacterEntity(id = "1", name = "Harry Potter", actor = "Daniel Radcliffe", dateOfBirth = "","", true, "", "")
        dao.upsertCharacter(character)

        val searchResult = dao.searchCharacters("")
